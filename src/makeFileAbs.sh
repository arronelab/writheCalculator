...
g++ -c -O3 -march=native -std=gnu++14 mainFileAbs.cpp
g++ -O3 -march=native -std=gnu++14 -o AbsDI point.o binaryFind.o getSections.o mutualWind2.o localWrithe.o mainFileAbs.o