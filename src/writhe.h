...
public:
  ...
  //std::pair<std::vector<std::pair<std::pair<int,int>,std::pair<int,int> > >,std::pair<double,double> > compareFingerPrints(std::vector<point>& fp1In,int& len1,std::vector<point>& fp2In,int& len2,double& cutOff);
